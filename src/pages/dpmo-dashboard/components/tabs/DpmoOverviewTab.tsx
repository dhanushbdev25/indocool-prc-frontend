...
import { DpmoSkeleton } from '../DpmoSkeleton';
import {
	GATE_SPLIT_SERIES,
...
/**
 * The current DPMO dashboard, built on the three dpmometrics endpoints.
 * Rendered as the "Overview" tab; the page title lives in DpmoDashboard.
 */
export const DpmoOverviewTab = () => {
	const {
		from,
		to,
		isReady,
