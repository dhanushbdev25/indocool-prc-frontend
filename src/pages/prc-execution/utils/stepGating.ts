...
// REVERTED: CTQ sequence sub-steps no longer require the quality permission to fill.
// Uncommenting this restores the predicate; its callers in StepDetailView.tsx,
// SequenceStep.tsx and execute-prc/index.tsx are commented out in the same way.
//
