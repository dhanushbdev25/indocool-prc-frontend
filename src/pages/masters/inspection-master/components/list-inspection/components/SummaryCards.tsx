...
import { InspectionHeader } from '../../../../../../store/api/business/inspection-master/inspection.validators';
	...
	const summaryData: SummaryCardData[] = [
		{
			...
			subtitle: `${headerData.ACTIVE} active inspections`,
			icon: <ChecklistIcon sx={{ color: '#666', fontSize: '1.5rem', opacity: 0.7 }} />
		},
		{
