...
const ViewInspection = () => {
	...
	const {
		...
		isError,
		error
	} = useFetchInspectionByIdQuery({ id: inspectionId }, { skip: !inspectionId });
	...
	const { inspection, inspectionParameters } = inspectionData.detail;
	...
	return (
		<Box sx={{ minHeight: '100vh' }}>
			<Paper sx={{ p: 4, borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
				...
				<Box sx={{ mb: 4 }}>
					<ViewInspectionBasicInfo inspection={inspection} />
				</Box>
