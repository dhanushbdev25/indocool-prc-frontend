...
const CatalystConfiguration: React.FC<CatalystConfigurationProps> = ({ 
    control, 
    errors
}) => {
    ...
    useEffect(() => {
        ...
        if (errors.catalystConfiguration && Array.isArray(errors.catalystConfiguration)) {
            (errors.catalystConfiguration as Record<string, unknown>[]).forEach((fieldErrors: Record<string, unknown>, index: number) => {
                ...
                {fields.length === 0 ? (
                    ...
                    <Box>
                        <Typography variant="body2" sx={{ color: '#666', mb: 3 }}>
                            Define different configurations for various temperature and humidity conditions. 
                            Each configuration specifies dosage ranges and safety settings.
                        </Typography>
